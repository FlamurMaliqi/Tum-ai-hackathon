...
from api.v1.routes import artikel_router, inventory_router, elevenlabs_client_token_router, ws_router, scribe_router
import uvicorn
...
app.include_router(scribe_router, prefix=apiPrefix)  
